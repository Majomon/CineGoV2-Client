...
const ModalProfile = ({ setActiveModal, userData }) => {
  ...
  return (
    <div className="w-80 h-40 flex flex-col top-14 right-0 bg-slate-300 dark:bg-black absolute border border-t-0 border-black dark:border-white dark:border-opacity-70 border-opacity-10 rounded-bl-md">
      ...
      >
        ...
        <span>{userData.isAdmin ? "Panel" : "Mi cuenta"}</span>
      </Link>
      <button
