const Ticket = ({ id, name, price, description, image, addToCard }) => {
  return (
    <div className="w-72 h-60 mx-10 rounded shadow-lg bg-primary-50  shadow-gray-600 hover:shadow-xl hover:shadow-gray-500 dark:bg-dark-950 dark:shadow-red-600 transform hover:scale-105 transition-transform duration-300 flex flex-col">
